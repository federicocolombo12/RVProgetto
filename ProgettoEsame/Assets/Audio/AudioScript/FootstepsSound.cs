...
public class FootstepSoundRigidbody : MonoBehaviour
{
    ...
    public float movementThreshold = 0.1f;  // Velocit� minima per considerare il movimento
    ...
    void Start()
    {
        ...
        // Aggiungi l'AudioSource se non � stato assegnato
    ...
    void CheckMovement()
    {
        // Ottieni la velocit� attuale del Rigidbody
        Vector3 velocity = playerRigidbody.linearVelocity;

        // Se il giocatore si sta muovendo e la velocit� � superiore alla soglia
        if (velocity.magnitude > movementThreshold)
        {
            // Se il suono non � gi� in riproduzione, lo riproduciamo
        ...
        {
            // Se il giocatore � fermo, fermiamo il suono
    ...
    {
        // Riproduce il suono dei passi solo se il suono non � gi� in riproduzione
